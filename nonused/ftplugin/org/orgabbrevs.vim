...
iabbrev <buffer> h5 *****
iabbrev <buffer> h6 ******
iabbrev <buffer> oft #+FILETAGS: ::<Left><C-R>=Eatchar('\s')<CR>
iabbrev <buffer> oct #+BEGIN_CENTER<CR><CR>#+END_CENTER<Up><C-R>=Eatchar('\s')<CR>
iabbrev <buffer> ole #+BEGIN_LEFT<CR><CR>#+END_LEFT<Up><C-R>=Eatchar('\s')<CR>
iabbrev <buffer> ori #+BEGIN_RIGHT<CR><CR>#+END_RIGHT<Up><C-R>=Eatchar('\s')<CR>
iabbrev <buffer> osr #+BEGIN_SRC<CR><CR>#+END_SRC<Up><Up><C-o>$
...
iabbrev <silent><buffer> cm <C-o>0#
