hi clear
syntax reset
let g:colors_name = "neodrac"
set background=dark
set t_Co=256
hi Normal guifg=#dadada ctermbg=NONE guibg=#353747 gui=NONE
...
hi DiffText guifg=#ec1cf5 guibg=NONE
hi ErrorMsg guifg=#ec1cf5 guibg=NONE
hi WarningMsg guifg=#ec1cf5 guibg=NONE
hi PreProc guifg=#ec1cf5 guibg=NONE
hi Exception guifg=#ec1cf5 guibg=NONE
hi Error guifg=#ec1cf5 guibg=NONE
hi DiffDelete guifg=#ec1cf5 guibg=NONE
hi GitGutterDelete guifg=#ec1cf5 guibg=NONE
hi GitGutterChangeDelete guifg=#ec1cf5 guibg=NONE
hi cssIdentifier guifg=#ec1cf5 guibg=NONE
hi cssImportant guifg=#ec1cf5 guibg=NONE
hi Type guifg=#ec1cf5 guibg=NONE
hi Identifier guifg=#ec1cf5 guibg=NONE
...
hi Directory guifg=#afa1b8 guibg=NONE
hi markdownLinkText guifg=#afa1b8 guibg=NONE
hi javaScriptBoolean guifg=#afa1b8 guibg=NONE
hi Include guifg=#afa1b8 guibg=NONE
hi Storage guifg=#afa1b8 guibg=NONE
hi cssClassName guifg=#afa1b8 guibg=NONE
hi cssClassNameDot guifg=#afa1b8 guibg=NONE
...
hi LineNr guifg=#747474 guibg=#353747
hi NonText guifg=#c481ff guibg=#353747
...
hi StatusLineNC gui=NONE guibg=#353747 guifg=#dadada
