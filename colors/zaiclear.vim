" Name:         zaiclear
" Description:  "If you believe the journalists, he's the single wealthiest individual, period. As rich as some zaibatsu. But there's the catch, really: is he an individual? In the sense that you are, or I am? No." -- William Gibson, Count Zero, An adaptation with a little bit lighter backround for zaibatsu colorscheme
...
hi clear
let g:colors_name = 'zaiclear'

let s:t_Co = has('gui_running') ? -1 : (&t_Co ?? 0)

if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1f0028', '#d7005f', '#00af5f', '#ffaf00', '#5f5fff', '#d700ff', '#00afff', '#d7d5db', '#878092', '#ff5faf', '#00d700', '#ffd700', '#8787ff', '#ff87ff', '#00ffff', '#ffffff']
endif
hi Normal guifg=#ffffff guibg=#1f0028 gui=NONE cterm=NONE
hi EndOfBuffer guifg=#afafff guibg=#1f0028 gui=NONE cterm=NONE
hi NonText guifg=#878092 guibg=#1f0028 gui=NONE cterm=NONE
...
hi StatusLine guifg=#1f0028 guibg=#ffffff gui=NONE cterm=NONE
hi StatusLineNC guifg=#1f0028 guibg=#afaab6 gui=NONE cterm=NONE
hi Pmenu guifg=#1f0028 guibg=#ffffff gui=NONE cterm=NONE
hi PmenuSbar guifg=#d7d5db guibg=#d7d5db gui=NONE cterm=NONE
hi PmenuSel guifg=#1f0028 guibg=#afafff gui=NONE cterm=NONE
...
hi WildMenu guifg=#1f0028 guibg=#afafff gui=NONE cterm=NONE
hi Conceal guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi Cursor guifg=#1f0028 guibg=#ffff5f gui=NONE cterm=NONE
hi CursorIM guifg=#1f0028 guibg=#ffff5f gui=NONE cterm=NONE
...
hi Folded guifg=#ffaf00 guibg=#1f0028 gui=reverse cterm=reverse
hi IncSearch guifg=#ffaf00 guibg=#1f0028 gui=reverse cterm=reverse
...
hi ModeMsg guifg=#1f0028 guibg=#87ff00 gui=NONE cterm=NONE
hi MoreMsg guifg=#87ffff guibg=NONE gui=NONE cterm=NONE
hi Question guifg=#87ff00 guibg=NONE gui=NONE cterm=NONE
hi QuickFixLine guifg=#ffafff guibg=#1f0028 gui=reverse cterm=reverse
hi Search guifg=#87ffff guibg=#1f0028 gui=reverse cterm=reverse
...
hi Visual guifg=#1f0028 guibg=#5fd7ff gui=NONE cterm=NONE
hi VisualNOS guifg=#1f0028 guibg=#ffffff gui=NONE cterm=NONE
...
" Background: dark
" Color: background    #1f0028           16                black
